...
LOCAL_ARM_MODE      := arm
CLANG_VERSION       ?= 3.1
OPENAL_DIR          := ../../../../../../lib/openal/Android/OpenAL
MODULE              := openal
...
LOCAL_CFLAGS        +=  -I$(LOCAL_PATH)/$(OPENAL_DIR) \
                        -I$(LOCAL_PATH)/$(OPENAL_DIR)/include \
...
MAX_SOURCES_START ?= 8
MAX_SOURCES_HIGH ?= 64
LOCAL_CFLAGS += -DPOST_FROYO -DMAX_SOURCES_LOW=$(MAX_SOURCES_LOW) -DMAX_SOURCES_START=$(MAX_SOURCES_START) -DMAX_SOURCES_HIGH=$(MAX_SOURCES_HIGH)
